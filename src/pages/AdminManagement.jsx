...
export default function AdminManagement() {
  ...
  const previewUpiPayUrl = `upi://pay?pa=${encodeURIComponent(effectiveUpiId)}&pn=${encodeURIComponent(settings.upiName || 'सार्वजनिक श्री गणेश उत्सव मंडळ')}&cu=INR`;
  const autoGeneratedQrUrl = `https://api.qrserver.com/v1/create-qr-code/?size=300x300&data=${encodeURIComponent(previewUpiPayUrl)}`;
